...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.cognizant.complianceservice.exception.BadRequestException.class)
    public ResponseEntity<Map<String, Object>> handleBadRequest(com.cognizant.complianceservice.exception.BadRequestException ex) {
